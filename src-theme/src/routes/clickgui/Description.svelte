...
<style lang="scss">
  ...
  .description {
    position: relative;
    border-radius: 5px;
    background-color: rgba(colors.$clickgui-base-color, .9);
    filter: drop-shadow(0 0 10px rgba(colors.$clickgui-base-color, 0.5));
    ...
    &::before {
      ...
      border-right: 8px solid rgba(colors.$clickgui-base-color, .9);
      left: -8px;
      top: 50%;
      transform: translateY(-50%);
    }
