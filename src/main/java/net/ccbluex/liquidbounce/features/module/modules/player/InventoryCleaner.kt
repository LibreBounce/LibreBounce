    ...
    private fun isUsefulLighter(
        ...
        return stacksToIterate.withIndex().none { (otherIndex, otherStack) ->
            ...
            if (index == otherIndex) {
                ...
                return distanceSqToItem > mc.thePlayer.getDistanceSqToEntity(otherItemEntity)
            }
            ...
            when (otherStackSaturation.compareTo(stackSaturation)) {
                ...
                0 -> {
                    ...
                    if (index == otherIndex) {
                        ...
                        distanceSqToItem > mc.thePlayer.getDistanceSqToEntity(otherItemEntity)
                    } else {
                    ...
                    0 -> when (otherStack.totalDurability.compareTo(stack.totalDurability)) {
                        ...
                        0 -> {
                            ...
                            if (index == otherIndex) {
                                ...
                                when (distanceSqToItem.compareTo(mc.thePlayer.getDistanceSqToEntity(otherItemEntity))) {
                                    1 -> return false
