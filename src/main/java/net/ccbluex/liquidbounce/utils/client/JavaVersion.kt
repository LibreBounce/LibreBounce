        ...
        when {
            ...
            major == "1" -> when {
                ...
                minor.toInt() < 8 -> {
                    ...
                    error("You should start ${LiquidBounce.CLIENT_NAME} with Java 8! Get it from $DOWNLOAD_PAGE")
                }
                // < Java 8u100, warn
                update.toInt() < 100 -> {
            ...
            major.toInt() > 8 -> {
                SharedScopes.IO.launch {
                    MiscUtils.showMessageDialog(
                        title = "Warning",
                        message = "This version of ${LiquidBounce.CLIENT_NAME} is designed for Java 8 environment.\n"
