...
inline fun <reified T> JsonElement.decode(gson: Gson = GSON): T = gson.fromJson(this, object : TypeToken<T>() {}.type)

inline fun <reified T> Reader.decodeJson(gson: Gson = GSON): T = gson.fromJson(this, object : TypeToken<T>() {}.type)

inline fun <reified T> String.decodeJson(gson: Gson = GSON): T = gson.fromJson(this, object : TypeToken<T>() {}.type)
