...
object ComponentManager : EventListener {

    val activeComponents
        @Suppress("UNCHECKED_CAST")
        get() = ModuleHud.layouts.activeChoice.inner as List<Component>
    ...
    fun getComponentsWithTweak(tweak: ComponentTweak): List<Component> {
        ...
        return activeComponents.filter { component -> component.enabled && component.tweaks.contains(tweak) }
    }
