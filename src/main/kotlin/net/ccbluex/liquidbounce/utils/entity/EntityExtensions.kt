...
fun LivingEntity.getDamageFromExplosion(
    ...
    try {
        ...
        // TODO: where did the implementation in the Explosion class go?
        val exposure = getExposureToExplosion(pos, exclude, include, maxBlastResistance, entityBoundingBox)
